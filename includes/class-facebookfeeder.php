...
class Plugin_Name {
	...
	public function __construct() {
		...
		$this->plugin_name = 'facebookfeeder';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-facebookfeeder-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-facebookfeeder-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-facebookfeeder-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-facebookfeeder-public.php';

                /**
                * All the facebook business
                */
                require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-facebook-graph-parse.php';
